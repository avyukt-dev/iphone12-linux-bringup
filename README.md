...
```bash
bash scripts/bootstrap.sh                 # small source checkouts
bash scripts/bootstrap.sh --with-kernel   # also clone the large kernel fork
...
See [engineering gates](docs/bringup-plan.md), [repository inventory](reports/upstream-inventory.md), and the [development policy](docs/development-policy.md). Hardware/bootloader changes belong on separate review branches in their corresponding forks.
