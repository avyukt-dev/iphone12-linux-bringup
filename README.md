...
The [production-A14 boot-entry research](reports/production-a14-bootrom-assessment-2026-09-23.md) distinguishes pre-production A14 A0/B0 from the production A14 B1 Boot ROM; the cited `usbliter8` weakness is not documented on production A14. Use `python3 scripts/triage_boot_entries.py` for OFFLINE paper-scope classification. It does not approve any physical test or establish native boot.
